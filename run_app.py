...
#what is the significance of this route other than allowing for variable access?  
#what is a route? 
...
def search_user():
    ...
    user_filter = [user for user in users if search.lower() in user.lower()]

    return 'Found {} users that match with search: "{}"'.format(len(user_filter), search)
